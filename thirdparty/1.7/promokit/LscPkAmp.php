...
class LscPkAmp extends LscIntegration
{
    ...
    {
        return [
            'pk_amphomeModuleFrontController' => Conf::TAG_HOME, // controller name - tag linked to it
            ...
            'pk_ampsearchModuleFrontController' => Conf::TAG_SEARCH,
            'pk_ampbestsalesModuleFrontController' => Conf::TAG_SEARCH,
            'pk_ampnewProductsModuleFrontController' => Conf::TAG_SEARCH,
            'pk_amppricesdropModuleFrontController' => Conf::TAG_SEARCH,
            'pk_ampsitemapModuleFrontController' => Conf::TAG_SITEMAP,
            'pk_ampstoresModuleFrontController' => Conf::TAG_STORES,
