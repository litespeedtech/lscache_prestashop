...
class ObjConfig
{
    public const ENTRY = 'LITESPEED_CACHE_OBJ';

    public const OBJ_ENABLE = 'obj_enable';
    public const OBJ_METHOD = 'obj_method';
    public const OBJ_HOST = 'obj_host';
    public const OBJ_PORT = 'obj_port';
    public const OBJ_TTL = 'obj_ttl';
    public const OBJ_USERNAME = 'obj_username';
    public const OBJ_PASSWORD = 'obj_password';
    public const OBJ_REDIS_DB = 'obj_redis_db';
    public const OBJ_GLOBAL_GROUPS = 'obj_global_groups';
    public const OBJ_NOCACHE_GROUPS = 'obj_nocache_groups';
    public const OBJ_PERSISTENT = 'obj_persistent';
    public const OBJ_ADMIN_CACHE = 'obj_admin_cache';
