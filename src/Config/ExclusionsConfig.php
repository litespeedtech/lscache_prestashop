...
{
    public const ENTRY = 'LITESPEED_CACHE_EXCL';

    public const EXCL_NOCACHE_CATS = 'exc_nocache_cats';
    public const EXCL_NOCACHE_COOKIES = 'exc_nocache_cookies';
    public const EXCL_NOCACHE_UA = 'exc_nocache_ua';
    public const EXCL_NOCACHE_ROLES = 'exc_nocache_roles';
