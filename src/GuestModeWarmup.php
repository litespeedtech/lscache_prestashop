...
class GuestModeWarmup extends Command
{
    protected $output;
    ...
    protected function configure()
    {
        ...
        $this->setName('litespeedcache:guestmodewarmup')
    ...
    private function crawlUrls($urls) {
        ...
        $total = count($urls);
        $current = 0;
        $cookie = 'lsc_private=e70f67d087a65a305e80267ba3bfbc97;PrestaShop-crawler=litespeed';
